...
const ScheduleItemCard = ({ lesson, isTeacher }: ScheduleItemCardProps) => {
	...
	// Students can cancel their own lesson any time before it actually
	// starts — the server enforces this too, this just avoids offering a
	// cancel button that would only come back as a rejected request.
	const canCancel = !isTeacher && isJoinable && startDate > new Date();
